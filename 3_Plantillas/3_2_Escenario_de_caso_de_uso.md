...
Esta es la plantilla para el [escenario](/4_Conceptos/4_Escenario_de_caso_de_uso.md) de un
...
Los escenarios de caso de uso muestran la funcionalidad de un caso de uso
dividiéndolo en una serie de pasos fácilmente reconocibles, escritos en lenguaje
natural para que sean accesibles para todos los
