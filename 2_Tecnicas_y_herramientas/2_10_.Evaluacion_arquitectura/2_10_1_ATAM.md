...
5. **Generar el árbol de utilidad de atributos de calidad**. Se obtienen los
   ...
   energética](/4_Conceptos/4_Eficiencia_energetica.md), [facilidad de
...
8. **Analizar los enfoques arquitectónicos**. Este paso reitera el paso 6, pero
   aquí los escenarios mejor calificados del paso 7 se consideran casos de
