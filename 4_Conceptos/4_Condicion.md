...
cuantitativo medible que se estipula para un
[requerimiento](./4_Requerimiento.md) y que indica una circunstancia o evento
bajo el cual se aplica un requerimiento[^1].
